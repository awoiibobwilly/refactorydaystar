...
urlpatterns = [
    ...
    path('financereport/', views.finance_report, name='financereport'),
    ...
    path('edit_sales/<int:sales_id>/', views.edit_sales, name='edit_sales'),
    path('delete_sales/<int:sales_id>/', views.delete_sales, name='delete_sales'),
    ...
    path('dashboard/', views.general_counts_view, name='dashboard'),
